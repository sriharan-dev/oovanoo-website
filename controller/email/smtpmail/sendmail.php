...
if(isset($_POST["send"])){
	...
	$mail->Username = "test@rjbuilders.co.in"; //Username for SMTP authentication any valid email created in your domain
	$mail->Password = "pass,123"; //Password for SMTP authentication
	$mail->AddReplyTo("test@rjbuilders.co.in", "Reply name"); //reply-to address
	$mail->SetFrom("info@rjbuilders.co.in", "The King Phoenix"); //From address of the mail
	...
	$mail->MsgHTML("<b>Hi, your first SMTP mail has been received. Great Job!</b>"); //Put your body of the message you can place html code here
